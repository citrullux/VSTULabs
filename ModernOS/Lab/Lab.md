...
Распространённый ответ на этот вопрос у студентов - ну конечно-же __да__, ведь вот на экране __операционная система(ОС)__, будь то  Linux, Windows, macOS, Android, iOS _и дальше можно перечислять до бесконечности_, разве взаимодействие с ОС через экран, клавиатуру и другие устройства ввода не значит само по себе взаимодействие с ОС?

С какой-то стороны звучит такая позиция очень разумно. Но есть один момент.
...
Вы никогда не задумывались что вообще происходит когда мы запускаем компьютер? Я не говорю о инициализации устройств BIOS или UEFI. Но после них начинает загружаться сама ОС.
