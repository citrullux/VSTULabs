...
Перед вами окно конфигурации звука для DOS версии игры Doom, и это прямой пример того, что случается, когда мы оставляем взаимодействие с чем-либо на программу вместо того чтобы работать через операционную систему.

Проблема, которую обозначает этот рисунок заключается в том, что для поддержки вывода звука из игры нужно всего-лишь написать собственную реализацию для каждой конкретной звуковой карты.
