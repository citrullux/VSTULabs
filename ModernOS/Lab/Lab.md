...
Получите любые данные из сети или с компьютера (к примеру, содержимое определённых директорий) посредством приложения на любом язке программирования с выводом полученной информации в браузере, и создайте на основе этого приложения демона (службу).